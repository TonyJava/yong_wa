...
ActiveRecord::Schema.define(version: 20160511021132) do
  ...
  create_table "cellocations", force: :cascade do |t|
    t.string   "mnc",          limit: 255
  ...
  create_table "devices", force: :cascade do |t|
    ...
    t.text     "tracking_info", limit: 16777215
    t.text     "health_info",   limit: 65535
  end

  create_table "histories", force: :cascade do |t|
    t.integer  "data_type",          limit: 4
    t.text     "data_content",       limit: 65535
    ...
    t.string   "data_description",   limit: 255
  end
